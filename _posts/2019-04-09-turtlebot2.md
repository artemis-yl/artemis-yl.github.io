...
I collobarated to tune the laser scan code and code the exploration strategy. 

![img2](/images/projects/turtlebot2/flowchart_controller_architecture.PNG "Contest 1 Flowchart"){:width="300"} | ![img2](/images/projects/turtlebot2/discretation_process_laserCallback.PNG "How the Laser Works"){:width="300"}
:------------: | :-------------: 
Diagram credit to Christine for drawing it | Image credit to the course
