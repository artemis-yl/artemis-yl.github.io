...
my OG class charts and wire frames here

### App Architecture: MVVM and Other Classes: <a name="2b"></a>

show new class chart with MVVM labels. Explain flow of data/UI
...
Improving my live search.

Adding other GET to receive province/state data + historicl data.

Being able to do data analysis/ graphing to show trends.

It is my hope that I will add in provinces/states of availible countries to view, then add other statistics such as cases for past days, graphs showing trends, etc. 
